...
pub fn get_help_text() -> Vec<String> {
  vec![
    ...
    "    :q, :quit, :exit  Quit".to_string(),
    "    :help       Show this help".to_string(),
    "    :commands   Show this help".to_string(),
    "    :tutorial   Start interactive tutorial".to_string(),
    "    :next       Next tutorial step (when completed)".to_string(),
    "    :back       Previous tutorial step".to_string(),
    "    :z          Toggle line highlighter".to_string(),
    "    :p          Toggle progress display".to_string(),
    "    :cursor     Toggle cursor visibility".to_string(),
    "    :h          Highlight selected text (in visual mode)".to_string(),
    "    :next       Next step in tutorial (tutorial mode only)".to_string(),
    "    :continue   Next step in tutorial (tutorial mode only)".to_string(),
    "    :!{cmd}     Execute shell command".to_string(),
    "".to_string(),
    ...
    "".to_string(),
    "Press 'q' or ':q' to close this help.".to_string(),
  ]
}